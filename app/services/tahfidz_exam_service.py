from app.repositories.tahfidz_exam_repo import (
    save_tahfidz_exam_attempt,
    get_last_tahfidz_exam,
    get_best_tahfidz_exam_score,
)
...
def submit_tahfidz_exam(user_id: int, total_questions: int, correct_answers: int, recording_scores: list):
...
def get_tahfidz_exam_progress(user_id: int):
    last = get_last_tahfidz_exam(user_id)
    best = get_best_tahfidz_exam_score(user_id)
