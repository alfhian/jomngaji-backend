from app.repositories.tilawah_exam_repo import (
    save_tilawah_exam_attempt,
    get_last_tilawah_exam,
    get_best_tilawah_exam_score,
)
...
def submit_tilawah_exam(user_id: int, total_questions: int, correct_answers: int, recording_scores: list):
...
def get_tilawah_exam_progress(user_id: int):
    last = get_last_tilawah_exam(user_id)
    best = get_best_tilawah_exam_score(user_id)
